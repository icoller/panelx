...
const message = {
    ...
    database: {
        ...
        loadFromRemoteHelper: '此操作将同步服务器上数据库信息到 PanelX，是否继续？',
    ...
    container: {
        ...
        composeHelper: '通过 PanelX 编辑或者模版创建的编排，将保存在 {0}/docker/compose 路径下',
        deleteFile: '删除文件',
        ...
        down: '删除',
        up: '启动',
        composeDetailHelper: '该 compose 为 PanelX 编排外部创建。暂不支持启停操作。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日志文件会备份到 PanelX 的 backup 目录下',
    },
    monitor: {
        monitor: '监控',
        globalFilter: '全局过滤',
    ...
    setting: {
        ...
        snapshot: '快照',
        status: '快照状态',
        panelInfo: '写入 PanelX 基础信息',
        panelBin: '备份 PanelX 系统文件',
        daemonJson: '备份 Docker 配置文件',
        appData: '备份 PanelX 已安装应用',
        panelData: '备份 PanelX 数据目录',
        backupData: '备份 PanelX 本地备份目录',
        compress: '制作快照文件',
        upload: '上传快照文件',
        ...
        versionChange: '版本变化',
        snapshotFrom: '快照存储位置',
        recoverHelper: '即将从快照 {0} 开始恢复，恢复需要重启 docker 以及 PanelX 服务，是否继续？',
        rollback: '回滚',
        rollbackHelper:
            '即将回滚本次恢复，回滚将替换所有本次恢复的文件，过程中可能需要重启 docker 以及 PanelX 服务，是否继续？',

        upgrading: '正在升级中，请稍候...',
        upgradeHelper: '升级操作需要重启服务，是否继续？',
        noUpgrade: '当前已经是最新版本',
        versionHelper: 'PanelX 版本号命名规则为： [大版本].[功能版本].[Bug 修复版本]，例：',
        ...
        bindDomainHelper: '设置域名绑定后，仅能通过设置中域名访问 PanelX 服务',
        bindDomainHelper1: '绑定域名为空时，则取消域名绑定',
        bindDomainWarning: '设置域名绑定后，将退出当前登录，且仅能通过设置中域名访问 PanelX 服务，是否继续？',
        allowIPs: '授权 IP',
        unAllowIPs: '取消授权',
        unAllowIPsWarning: '授权 IP 为空将允许所有 IP 访问系统，可能造成系统不安全，是否继续？',
        allowIPsHelper: '设置授权 IP 后，仅有设置中的 IP 可以访问 PanelX 服务',
        allowIPsWarning: '设置授权 IP 后，仅有设置中的 IP 可以访问 PanelX 服务，是否继续？',
        ...
        mfaCode: '验证码',
        mfaInterval: '刷新时间（秒）',
        mfaTitleHelper: '用于区分不同 PanelX 主机，修改后请重新扫描或手动添加密钥信息！',
        ...
        doc: '官方文档',
        star: '点亮 Star',
        description: 'PanelX，现代化、开源的 Linux 服务器运维管理面板。',
        forum: '论坛',
        doc2: '文档',
    ...
    website: {
        ...
        websiteDeploymentHelper: '使用从 PanelX 部署的应用创建网站',
        ...
        wafValueHelper: '值',
        wafRemarkHelper: '描述',
        runtimeProxyHelper: '使用从 PanelX 创建的运行环境',
        runtime: '运行环境',
