...
const message = {
    ...
    database: {
        ...
        loadFromRemoteHelper: '此操作將同步服務器上數據庫信息到 PanelX，是否繼續？',
    ...
    container: {
        ...
        composeHelper: '通過 PanelX 編輯或者模版創建的編排，將保存在 {0}/docker/compose 路徑下',
        deleteFile: '刪除文件',
        ...
        down: '刪除',
        up: '啟動',
        composeDetailHelper: '該 compose 為 PanelX 編排外部創建。暫不支持啟停操作。',
    ...
    cronjob: {
        ...
        cutWebsiteLogHelper: '切割的日誌文件會備份到 PanelX 的 backup 目錄下',
    },
    monitor: {
        monitor: '監控',
        globalFilter: '全局過濾',
    ...
    setting: {
        ...
        snapshot: '快照',
        status: '快照狀態',
        panelInfo: '寫入 PanelX 基礎信息',
        panelBin: '備份 PanelX 系統文件',
        daemonJson: '備份 Docker 配置文件',
        appData: '備份 PanelX 已安裝應用',
        panelData: '備份 PanelX 數據目錄',
        backupData: '備份 PanelX 本地備份目錄',
        compress: '製作快照文件',
        upload: '上傳快照文件',
        ...
        versionChange: '版本變化',
        snapshotFrom: '快照存儲位置',
        recoverHelper: '即將從快照 {0} 開始恢復，恢復需要重啟 docker 以及 PanelX 服務，是否繼續？',
        rollback: '回滾',
        rollbackHelper:
            '即將回滾本次恢復，回滾將替換所有本次恢復的文件，過程中可能需要重啟 docker 以及 PanelX 服務，是否繼續？',

        upgrading: '正在升級中，請稍候...',
        upgradeHelper: '升級操作需要重啟服務，是否繼續？',
        noUpgrade: '當前已經是最新版本',
        versionHelper: 'PanelX 版本號命名規則為： [大版本].[功能版本].[Bug 修復版本]，例：',
        ...
        bindDomainHelper: '設置域名綁定後，僅能通過設置中域名訪問 PanelX 服務',
        bindDomainHelper1: '綁定域名為空時，則取消域名綁定',
        bindDomainWarning: '設置域名綁定後，將退出當前登錄，且僅能通過設置中域名訪問 PanelX 服務，是否繼續？',
        allowIPs: '授權 IP',
        unAllowIPs: '取消授權',
        unAllowIPsWarning: '授權 IP 為空將允許所有 IP 訪問系統，可能造成系統不安全，是否繼續？',
        allowIPsHelper: '設置授權 IP 後，僅有設置中的 IP 可以訪問 PanelX 服務',
        allowIPsWarning: '設置授權 IP 後，僅有設置中的 IP 可以訪問 PanelX 服務，是否繼續？',
        ...
        mfaCode: '驗證碼',
        mfaInterval: '刷新時間（秒）',
        mfaTitleHelper: '用於區分不同 PanelX 主機，修改後請重新掃描或手動添加密鑰信息！',
        ...
        doc: '官方文檔',
        star: '點亮 Star',
        description: 'PanelX，現代化、開源的 Linux 服務器運維管理面板。',
        forum: '論壇',
        doc2: '文檔',
    ...
    website: {
        ...
        websiteDeploymentHelper: '使用從 PanelX 部署的應用創建網站',
        ...
        wafValueHelper: '值',
        wafRemarkHelper: '描述',
        runtimeProxyHelper: '使用從 PanelX 創建的運行環境',
        runtime: '運行環境',
